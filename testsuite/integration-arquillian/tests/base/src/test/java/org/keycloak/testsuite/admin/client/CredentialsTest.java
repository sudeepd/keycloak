...
public class CredentialsTest extends AbstractClientTest {
    ...
    public void testUploadKeyAndCertificate() throws Exception {
        ...
        keyCertForm.addFormData("keystoreFormat", "BCFKS", MediaType.TEXT_PLAIN_TYPE);
        keyCertForm.addFormData("keyAlias", "clientkey", MediaType.TEXT_PLAIN_TYPE);
        keyCertForm.addFormData("keyPassword", "averylongpassword", MediaType.TEXT_PLAIN_TYPE);
        keyCertForm.addFormData("storePassword", "averylongpassword", MediaType.TEXT_PLAIN_TYPE);

        URL idpMeta = getClass().getClassLoader().getResource("client-auth-test/keystore-client1.bcfks");
